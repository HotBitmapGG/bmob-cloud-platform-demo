 ...
 * @since 1.9.0
 */
public class GalleryImageViewAware extends ViewAware {
	 ...
	 */
	public GalleryImageViewAware(ImageView imageView) {
		super(imageView);
	}
	 ...
	 *                            <p/>
	 */
	public GalleryImageViewAware(ImageView imageView, boolean checkActualViewSize) {
