...
public class UserFriendAdapter extends BaseAdapter implements SectionIndexer
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            ImageLoader.getInstance().displayImage(avatar, viewHolder.avatar, ImageLoadUtil.defaultOptions());
        } else
        {
            viewHolder.avatar.setImageDrawable(ct.getResources().getDrawable(R.drawable.ico_user_default));
        }
