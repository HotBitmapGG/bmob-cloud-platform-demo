...
public class MessageRecentAdapter extends ArrayAdapter<BmobRecent> implements Filterable
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        RoundedImageView iv_recent_avatar = ViewHolder.get(convertView, R.id.iv_recent_avatar);
        ...
        {
            ImageLoader.getInstance().displayImage(avatar, iv_recent_avatar, ImageLoadUtil.defaultOptions());
        } else
        {
            iv_recent_avatar.setImageResource(R.drawable.ico_user_default);
        }
        ...
        {
            tv_recent_name.setText(nick);
        } else
        {
            tv_recent_name.setText(userName);
        }
