...
import com.hotbitmapgg.geekcommunity.activity.UserAlumnusActivity;
...
public class AIContentAdapter extends BaseContentAdapter<AlummusBean>
{
    ...
    public AIContentAdapter(Context context, List<AlummusBean> list)
    {
        super(context, list);
    ...
    public View getConvertView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            viewHolder.contentText = (EmojiconTextView) convertView.findViewById(R.id.content_text);
        ...
        viewHolder.userLogo.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                HomeMsgApplication.getInstance().setmAlummusBean(entity);
                Intent intent = new Intent();
                intent.setClass(mContext, UserAlumnusActivity.class);
        ...
        int love = entity.getLove();
        if(love == 0)
        {
            viewHolder.LoveNum.setText("喜欢");
        }
        else
        {
            viewHolder.LoveNum.setText(love + "");
        }
        ...
        else
        {
            ...
            viewHolder.LoveNum.setTextColor(mContext.getResources().getColor(R.color.gray_80));
