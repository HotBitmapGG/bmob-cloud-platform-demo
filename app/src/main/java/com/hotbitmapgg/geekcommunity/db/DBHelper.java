...
public class DBHelper extends SQLiteOpenHelper
{
	...
	private void onCreateFavTable(SQLiteDatabase db)
	{
		...
		favStr.append("CREATE TABLE IF NOT EXISTS ").append(DBHelper.TABLE_NAME).append(" ( ").append(FavTable._ID).append(" INTEGER PRIMARY KEY AUTOINCREMENT,").append(FavTable.USER_ID).append(" varchar(100),").append(FavTable.OBJECT_ID).append(" varchar(20),").append(FavTable.IS_FAV).append(" Integer,").append(FavTable.IS_LOVE).append(" Integer);");
